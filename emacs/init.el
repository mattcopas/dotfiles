...
;; Note that sometimes you need to M-x package-refresh-contents (especially if packages are not being found/404ing)
...
;; all-the-icons (required by doom-themes below)
