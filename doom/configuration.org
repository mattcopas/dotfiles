...
(when (eq system-type 'windows-nt)
        ...
        (setq doom-font (font-spec :family font-to-use :size 32)
...
#+BEGIN_SRC emacs-lisp
;; This is a huge hack
;; Because my windows and other versions of emacs are different versions (28 and 29, respectively) there are different variables use for
;; format on save. Currently this is fine as the windows machine is only really used for note taking
(unless (eq system-type 'windows-nt)
